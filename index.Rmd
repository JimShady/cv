...
![James D Smith](https://avatars1.githubusercontent.com/u/895125?s=400&v=4){width=80%}


Contact Info {#contact}
--------------------------------------------------------------------------------

- <i class="fa fa-envelope"></i> james.david.smith@gmail.com
- <i class="fa fa-github"></i> [github.com/JimShady](https://github.com/JimShady)
